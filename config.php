...
/*
 ...
 PLEASE NOTE: free accounts have limitations of 25,000 calls per month which i belive is more then enough but if this falls short for you , just create a new account in moz and get a new bunch of keys and rreplace your old ones.
*/

$accessID = "put your access id in between the quotes"; // Access ID 
$secretKey = "paste your secretkey in between the quotes"; // Secret key
